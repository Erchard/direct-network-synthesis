...
| DNS05-HYB | Can a fixed hybrid of class-local and boundary synthetic centers improve the train-sample-free candidate? | Only original train/validation for seeds 101,202,303,404,505 | dns05-hybrid-prototype-protocol.md, configs/dns05_hybrid_prototype_digits.json | Preregistered |
