...
| DNS05-HYB | Can a fixed hybrid of class-local and boundary synthetic centers improve the train-sample-free candidate? | Planned digits train/validation development boundary only; no test scores | protocol/config not yet locked | Planned |
